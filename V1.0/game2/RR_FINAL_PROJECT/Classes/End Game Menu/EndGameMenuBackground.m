...
//
// This class is a CCLayer. It will be hold the background image for the End Game Menu
...
#import "EndGameMenuBackground.h"

@implementation EndGameMenuBackground
...
-(id) init
{
    ...
    if (self != nil)
    {
        ...
        {
            backgroundImage = [CCSprite spriteWithFile:@"end_game_background-ipadhd.png"];
        }else
        {
            backgroundImage = [CCSprite spriteWithFile:@"end_game_background-widehd.png"];
        }
